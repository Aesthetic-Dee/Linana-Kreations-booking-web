...
const NavLink = ({ href, label }) => (
  <a href={href} className="text-white hover:text-teal-300">
    {label}
  </a>
);
...
const Sidebar = ({ isOpen, toggle }) => (
  <div
    className={`fixed inset-y-0 left-0 bg-teal-700 w-64 z-50 flex flex-col shadow-lg transform transition-transform duration-300 ${
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
        ...
        <div className="flex-shrink-0 hidden md:block">
          <a href="/" className="text-2xl font-bold text-teal-700 font-viga">
            Liana-kreations
          </a>
        </div>
