  ...
  <div className="w-full">
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        <h2 className="mb-12 text-center text-3xl font-bold text-teal-800">Our Services</h2>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10 text-center">
          <a
            ...
            className="bg-deep-burgundy hover:bg-opacity-90 text-teal-700 font-medium py-3 px-8 rounded-full uppercase text-lg transition duration-300 ease-in-out"
          >
            See More
          </a>
        </div>
    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        <h2 className="mb-12 text-center text-3xl font-bold text-teal-800">Measurement Guide</h2>
        <div className="mx-auto max-w-3xl rounded-lg bg-teal-700 p-8 shadow-md">
          <GuideSection
...
const MeasurementArea = ({ title, items }) => (
  <div className="rounded-lg bg-teal-600 p-4 shadow">
