    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-6 md:px-12 lg:px-16">
        <h1 className="text-white text-4xl md:text-4xl lg:text-4xl font-thin uppercase tracking-widest leading-tight mb-4 animate-slideIn">
          Crafting Elegance{" "}
          <span className="block font-semibold text-teal-700">One Stitch at a Time</span>
        </h1>
        ...
        <Link
          ...
          duration={700}
          className="bg-white hover:bg-teal-700 text-teal-700 hover:text-white font-semibold py-3 px-10 rounded-full uppercase text-lg md:text-xl transition-transform transform hover:scale-105 shadow-lg shadow-deep-burgundy/50 hover:shadow-md hover:shadow-deep-burgundy/70 duration-300 ease-in-out animate-slideIn delay-400"
          role="button"
        >
          Book
        </Link>
